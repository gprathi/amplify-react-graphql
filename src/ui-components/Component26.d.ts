...
export declare type Component26OverridesProps = {
    Component26?: PrimitiveOverrideProps<IconProps>;
} & EscapeHatchProps;
export declare type Component26Props = React.PropsWithChildren<Partial<IconProps> & {
    property1?: "ion:boat" | "ion:boat-outline";
} & {

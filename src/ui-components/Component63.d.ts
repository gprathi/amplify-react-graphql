...
export declare type Component63OverridesProps = {
    Component63?: PrimitiveOverrideProps<IconProps>;
} & EscapeHatchProps;
export declare type Component63Props = React.PropsWithChildren<Partial<IconProps> & {
    property1?: "ion:image" | "ion:image-outline";
} & {
